package com.imooc.flink.transfoemation;
...
//        coMap(env);
    ...
    public static void coMap(StreamExecutionEnvironment env) {
        DataStreamSource<String> stream1 = env.socketTextStream("192.168.88.100", 9527);
        SingleOutputStreamOperator<Integer> stream2 = env.socketTextStream("192.168.88.100", 9528) // 数值类型
...
//        }).print();
    ...
    public static void union(StreamExecutionEnvironment env) {
        ...
        DataStreamSource<String> stream1 = env.socketTextStream("192.168.88.100", 9527);
        DataStreamSource<String> stream2 = env.socketTextStream("192.168.88.100", 9528);
